...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 15 Feb 2022 pada 02.26
...
(27, 'LNY-00003', '2021-11-10', 9, 'Selesai'),
(28, 'LNY-00004', '2022-02-10', 9, 'Boking'),
(29, 'LNY-00005', '2022-02-10', 9, 'Boking'),
(30, 'LNY-00006', '2022-02-10', 9, 'Boking'),
(31, 'LNY-00007', '2022-02-10', 9, 'Boking'),
(32, 'LNY-00008', '2022-02-10', 9, 'Proses');
...
(1, 'Tenlaundry', 'jl. laswi cipicung RT05/RW01 Kel. manggahang ', '082123431932');
...
CREATE TABLE `user` (
  ...
  `jenis` enum('Admin','Member','Owner') NOT NULL DEFAULT 'Member'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(1, 'deni', '43f41d127a81c54d4c8f5f93daeb7118', 'Owner'),
...
(8, 'illham', 'fbe60610487ed0811bf8962067e960e4', 'Member'),
(9, 'itech', 'd15e5300717f8d0729bca5aefbfeeff7', 'Owner');
...
--
ALTER TABLE `detailpemesanan`
  MODIFY `iddetailpemesanan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `pegawai`
  MODIFY `kd_pegawai` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
